...
public class MonsterSpawn6th : MonoBehaviour
{
    ...
    void Start()
    {
        spawner = GameObject.Find("MobSpawner6th");
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            this.transform.Find("SpawnPoint7").gameObject.SetActive(true);
            this.transform.Find("SpawnPoint8").gameObject.SetActive(true);
            this.transform.Find("SpawnPoint9").gameObject.SetActive(true);
            this.transform.Find("SpawnPoint10").gameObject.SetActive(true);
            this.transform.Find("SpawnPoint11").gameObject.SetActive(true);
        }
    }
